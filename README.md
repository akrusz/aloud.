...
| platform | download |
|----------|----------|
| **macOS** | [`Glooow-0.9.25-macOS.dmg`](https://github.com/akrusz/glooow/releases/download/v0.9.25/Glooow-0.9.25-macOS.dmg) — open the DMG, drag Glooow to Applications |
| **Windows** | [`Glooow-0.9.25-Windows.exe`](https://github.com/akrusz/glooow/releases/download/v0.9.25/Glooow-0.9.25-Windows.exe) — run the installer |
| **Linux** | [`Glooow-0.9.25-Linux.AppImage`](https://github.com/akrusz/glooow/releases/download/v0.9.25/Glooow-0.9.25-Linux.AppImage) — `chmod +x`, double-click or run from terminal |
