...
| platform | download |
|----------|----------|
| **macOS** | [`aloud-1.0.1-macOS.dmg`](https://github.com/akrusz/aloud/releases/download/v1.0.1/aloud-1.0.1-macOS.dmg) — open the DMG, drag aloud to Applications |
| **Windows** | [`aloud-1.0.1-Windows.exe`](https://github.com/akrusz/aloud/releases/download/v1.0.1/aloud-1.0.1-Windows.exe) — run the installer |
| **Linux** | [`aloud-1.0.1-Linux.AppImage`](https://github.com/akrusz/aloud/releases/download/v1.0.1/aloud-1.0.1-Linux.AppImage) — `chmod +x`, double-click or run from terminal |
