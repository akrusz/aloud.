...
| platform | download |
|----------|----------|
| **macOS** | [`Glooow-0.11.3-macOS.dmg`](https://github.com/akrusz/glooow/releases/download/v0.11.3/Glooow-0.11.3-macOS.dmg) — open the DMG, drag Glooow to Applications |
| **Windows** | [`Glooow-0.11.3-Windows.exe`](https://github.com/akrusz/glooow/releases/download/v0.11.3/Glooow-0.11.3-Windows.exe) — run the installer |
| **Linux** | [`Glooow-0.11.3-Linux.AppImage`](https://github.com/akrusz/glooow/releases/download/v0.11.3/Glooow-0.11.3-Linux.AppImage) — `chmod +x`, double-click or run from terminal |
