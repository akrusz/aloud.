...
| platform | download |
|----------|----------|
| **macOS** | [`Glooow-0.12.0-macOS.dmg`](https://github.com/akrusz/glooow/releases/download/v0.12.0/Glooow-0.12.0-macOS.dmg) — open the DMG, drag Glooow to Applications |
| **Windows** | [`Glooow-0.12.0-Windows.exe`](https://github.com/akrusz/glooow/releases/download/v0.12.0/Glooow-0.12.0-Windows.exe) — run the installer |
| **Linux** | [`Glooow-0.12.0-Linux.AppImage`](https://github.com/akrusz/glooow/releases/download/v0.12.0/Glooow-0.12.0-Linux.AppImage) — `chmod +x`, double-click or run from terminal |
