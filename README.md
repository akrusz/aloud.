...
| platform | download |
|----------|----------|
| **macOS** | [`Glooow-0.11.2-macOS.dmg`](https://github.com/akrusz/glooow/releases/download/v0.11.2/Glooow-0.11.2-macOS.dmg) — open the DMG, drag Glooow to Applications |
| **Windows** | [`Glooow-0.11.2-Windows.exe`](https://github.com/akrusz/glooow/releases/download/v0.11.2/Glooow-0.11.2-Windows.exe) — run the installer |
| **Linux** | [`Glooow-0.11.2-Linux.AppImage`](https://github.com/akrusz/glooow/releases/download/v0.11.2/Glooow-0.11.2-Linux.AppImage) — `chmod +x`, double-click or run from terminal |
