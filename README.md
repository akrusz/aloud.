...
glooow works on macOS, Linux, and Windows. choose your LLM — run fully local and private with ollama, use a claude subscription, or connect any API provider (anthropic, openai, openrouter, venice). all providers are configurable from the settings page. the app will also help you set up text-to-speech if it's not already configured.
...
| platform | download |
|----------|----------|
| **macOS** | [`Glooow-0.9.26-macOS.dmg`](https://github.com/akrusz/glooow/releases/download/v0.9.26/Glooow-0.9.26-macOS.dmg) — open the DMG, drag Glooow to Applications |
| **Windows** | [`Glooow-0.9.26-Windows.exe`](https://github.com/akrusz/glooow/releases/download/v0.9.26/Glooow-0.9.26-Windows.exe) — run the installer |
| **Linux** | [`Glooow-0.9.26-Linux.AppImage`](https://github.com/akrusz/glooow/releases/download/v0.9.26/Glooow-0.9.26-Linux.AppImage) — `chmod +x`, double-click or run from terminal |
