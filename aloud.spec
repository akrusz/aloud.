...
"""PyInstaller spec for aloud desktop app."""
...
if sys.platform == "darwin":
    _icon = "assets/aloud.icns"
elif sys.platform == "win32":
    _icon = "assets/aloud.ico"
else:
...
if sys.platform == "darwin":
    app = BUNDLE(
        coll,
        name='aloud.app',
        icon='assets/aloud.icns',
        bundle_identifier='app.aloud.meditation',
        codesign_identity=os.environ.get('CODESIGN_IDENTITY', '-'),
        entitlements_file='assets/entitlements.plist',
        info_plist={
            'NSMicrophoneUsageDescription':
                'aloud needs microphone access for voice-based meditation sessions.',
            'CFBundleShortVersionString': APP_VERSION,
            'CFBundleDisplayName': 'aloud.',
